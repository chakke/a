...
<script src="assets/js/hammer-time.min.js"></script>

13. ImagePicker 

ionic cordova plugin add cordova-plugin-telerik-imagepicker --variable PHOTO_LIBRARY_USAGE_DESCRIPTION="Chọn ảnh"
